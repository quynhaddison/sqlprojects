...
# Database: stores
# Generation Time: 2022-08-20 19:35:33 +0000
# ************************************************************
...
CREATE TABLE `customers` (
  ...
  `customerName` varchar(34) NOT NULL,
  `contactLastName` varchar(15) NOT NULL,
  `contactFirstName` varchar(11) NOT NULL,
...
CREATE TABLE `offices` (
  ...
  `addressLine2` varchar(9) NOT NULL,
...
CREATE TABLE `orderdetails` (
  `orderNumber` varchar(300) DEFAULT NULL,
  `productCode` varchar(300) DEFAULT NULL,
  `quantityOrdered` varchar(300) DEFAULT NULL,
  `priceEach` varchar(300) DEFAULT NULL,
  `orderLineNumber` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `orders` (
  ...
  `shippedDate` varchar(10) NOT NULL,
  `status` varchar(10) NOT NULL,
  `comments` varchar(189) NOT NULL,
  `customerNumber` varchar(62) NOT NULL,
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `FIELD8`)
VALUES
	(10100,'2003-01-06','2003-01-13','2003-01-10','Shipped','N','363',NULL),
	(10101,'2003-01-09','2003-01-18','2003-01-11','Shipped','Check on availability.','128',NULL),
	(10102,'2003-01-10','2003-01-18','2003-01-14','Shipped','N','181',NULL),
	(10103,'2003-01-29','2003-02-07','2003-02-02','Shipped','N','121',NULL),
	(10104,'2003-01-31','2003-02-09','2003-02-01','Shipped','N','141',NULL),
	(10105,'2003-02-11','2003-02-21','2003-02-12','Shipped','N','145',NULL),
	(10106,'2003-02-17','2003-02-24','2003-02-21','Shipped','N','278',NULL),
	...
	(10108,'2003-03-03','2003-03-12','2003-03-08','Shipped','N','385',NULL),
	(10109,'2003-03-10','2003-03-19','2003-03-11','Shipped','Customer requested that FedEx Ground is used for this shipping','486',NULL),
	(10110,'2003-03-18','2003-03-24','2003-03-20','Shipped','N','187',NULL),
	(10111,'2003-03-25','2003-03-31','2003-03-30','Shipped','N','129',NULL),
	...
	(10113,'2003-03-26','2003-04-02','2003-03-27','Shipped','N','124',NULL),
	(10114,'2003-04-01','2003-04-07','2003-04-02','Shipped','N','172',NULL),
	(10115,'2003-04-04','2003-04-12','2003-04-07','Shipped','N','424',NULL),
	(10116,'2003-04-11','2003-04-19','2003-04-13','Shipped','N','381',NULL),
	(10117,'2003-04-16','2003-04-24','2003-04-17','Shipped','N','148',NULL),
	...
	(10119,'2003-04-28','2003-05-05','2003-05-02','Shipped','N','382',NULL),
	(10120,'2003-04-29','2003-05-08','2003-05-01','Shipped','N','114',NULL),
	(10121,'2003-05-07','2003-05-13','2003-05-13','Shipped','N','353',NULL),
	(10122,'2003-05-08','2003-05-16','2003-05-13','Shipped','N','350',NULL),
	(10123,'2003-05-20','2003-05-29','2003-05-22','Shipped','N','103',NULL),
	...
	(10125,'2003-05-21','2003-05-27','2003-05-24','Shipped','N','114',NULL),
	(10126,'2003-05-28','2003-06-07','2003-06-02','Shipped','N','458',NULL),
	...
	(10128,'2003-06-06','2003-06-12','2003-06-11','Shipped','N','141',NULL),
	(10129,'2003-06-12','2003-06-18','2003-06-14','Shipped','N','324',NULL),
	(10130,'2003-06-16','2003-06-24','2003-06-21','Shipped','N','198',NULL),
	(10131,'2003-06-16','2003-06-25','2003-06-21','Shipped','N','447',NULL),
	(10132,'2003-06-25','2003-07-01','2003-06-28','Shipped','N','323',NULL),
	(10133,'2003-06-27','2003-07-04','2003-07-03','Shipped','N','141',NULL),
	(10134,'2003-07-01','2003-07-10','2003-07-05','Shipped','N','250',NULL),
	(10135,'2003-07-02','2003-07-12','2003-07-03','Shipped','N','124',NULL),
	(10136,'2003-07-04','2003-07-14','2003-07-06','Shipped','Customer is interested in buying more Ferrari models','242',NULL),
	(10137,'2003-07-10','2003-07-20','2003-07-14','Shipped','N','353',NULL),
	(10138,'2003-07-07','2003-07-16','2003-07-13','Shipped','N','496',NULL),
	(10139,'2003-07-16','2003-07-23','2003-07-21','Shipped','N','282',NULL),
	(10140,'2003-07-24','2003-08-02','2003-07-30','Shipped','N','161',NULL),
	(10141,'2003-08-01','2003-08-09','2003-08-04','Shipped','N','334',NULL),
	(10142,'2003-08-08','2003-08-16','2003-08-13','Shipped','N','124',NULL),
	(10143,'2003-08-10','2003-08-18','2003-08-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?','320',NULL),
	(10144,'2003-08-13','2003-08-21','2003-08-14','Shipped','N','381',NULL),
	(10145,'2003-08-25','2003-09-02','2003-08-31','Shipped','N','205',NULL),
	(10146,'2003-09-03','2003-09-13','2003-09-06','Shipped','N','447',NULL),
	(10147,'2003-09-05','2003-09-12','2003-09-09','Shipped','N','379',NULL),
	(10148,'2003-09-11','2003-09-21','2003-09-15','Shipped','They want to reevaluate their terms agreement with Finance.','276',NULL),
	(10149,'2003-09-12','2003-09-18','2003-09-17','Shipped','N','487',NULL),
	(10150,'2003-09-19','2003-09-27','2003-09-21','Shipped','They want to reevaluate their terms agreement with Finance.','148',NULL),
	(10151,'2003-09-21','2003-09-30','2003-09-24','Shipped','N','311',NULL),
	(10152,'2003-09-25','2003-10-03','2003-10-01','Shipped','N','333',NULL),
	(10153,'2003-09-28','2003-10-05','2003-10-03','Shipped','N','141',NULL),
	(10154,'2003-10-02','2003-10-12','2003-10-08','Shipped','N','219',NULL),
	(10155,'2003-10-06','2003-10-13','2003-10-07','Shipped','N','186',NULL),
	(10156,'2003-10-08','2003-10-17','2003-10-11','Shipped','N','141',NULL),
	(10157,'2003-10-09','2003-10-15','2003-10-14','Shipped','N','473',NULL),
	(10158,'2003-10-10','2003-10-18','2003-10-15','Shipped','N','121',NULL),
	(10159,'2003-10-10','2003-10-19','2003-10-16','Shipped','N','321',NULL),
	(10160,'2003-10-11','2003-10-17','2003-10-17','Shipped','N','347',NULL),
	(10161,'2003-10-17','2003-10-25','2003-10-20','Shipped','N','227',NULL),
	(10162,'2003-10-18','2003-10-26','2003-10-19','Shipped','N','321',NULL),
	(10163,'2003-10-20','2003-10-27','2003-10-24','Shipped','N','424',NULL),
	...
	(10166,'2003-10-21','2003-10-30','2003-10-27','Shipped','N','462',NULL),
	(10167,'2003-10-23','2003-10-30','N','Cancelled','Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.','448',NULL),
	(10168,'2003-10-28','2003-11-03','2003-11-01','Shipped','N','161',NULL),
	(10169,'2003-11-04','2003-11-14','2003-11-09','Shipped','N','276',NULL),
	(10170,'2003-11-04','2003-11-12','2003-11-07','Shipped','N','452',NULL),
	(10171,'2003-11-05','2003-11-13','2003-11-07','Shipped','N','233',NULL),
	(10172,'2003-11-05','2003-11-14','2003-11-11','Shipped','N','175',NULL),
	...
	(10174,'2003-11-06','2003-11-15','2003-11-10','Shipped','N','333',NULL),
	(10175,'2003-11-06','2003-11-14','2003-11-09','Shipped','N','324',NULL),
	(10176,'2003-11-06','2003-11-15','2003-11-12','Shipped','N','386',NULL),
	(10177,'2003-11-07','2003-11-17','2003-11-12','Shipped','N','344',NULL),
	...
	(10180,'2003-11-11','2003-11-19','2003-11-14','Shipped','N','171',NULL),
	(10181,'2003-11-12','2003-11-19','2003-11-15','Shipped','N','167',NULL),
	(10182,'2003-11-12','2003-11-21','2003-11-18','Shipped','N','124',NULL),
	...
	(10184,'2003-11-14','2003-11-22','2003-11-20','Shipped','N','484',NULL),
	(10185,'2003-11-14','2003-11-21','2003-11-20','Shipped','N','320',NULL),
	...
	(10187,'2003-11-15','2003-11-24','2003-11-16','Shipped','N','211',NULL),
	(10188,'2003-11-18','2003-11-26','2003-11-24','Shipped','N','167',NULL),
	(10189,'2003-11-18','2003-11-25','2003-11-24','Shipped','They want to reevaluate their terms agreement with Finance.','205',NULL),
	(10190,'2003-11-19','2003-11-29','2003-11-20','Shipped','N','141',NULL),
	...
	(10192,'2003-11-20','2003-11-29','2003-11-25','Shipped','N','363',NULL),
	(10193,'2003-11-21','2003-11-28','2003-11-27','Shipped','N','471',NULL),
	(10194,'2003-11-25','2003-12-02','2003-11-26','Shipped','N','146',NULL),
	(10195,'2003-11-25','2003-12-01','2003-11-28','Shipped','N','319',NULL),
	(10196,'2003-11-26','2003-12-03','2003-12-01','Shipped','N','455',NULL),
	(10197,'2003-11-26','2003-12-02','2003-12-01','Shipped','Customer inquired about remote controlled models and gold models.','216',NULL),
	(10198,'2003-11-27','2003-12-06','2003-12-03','Shipped','N','385',NULL),
	(10199,'2003-12-01','2003-12-10','2003-12-06','Shipped','N','475',NULL),
	(10200,'2003-12-01','2003-12-09','2003-12-06','Shipped','N','211',NULL),
	(10201,'2003-12-01','2003-12-11','2003-12-02','Shipped','N','129',NULL),
	(10202,'2003-12-02','2003-12-09','2003-12-06','Shipped','N','357',NULL),
	(10203,'2003-12-02','2003-12-11','2003-12-07','Shipped','N','141',NULL),
	(10204,'2003-12-02','2003-12-10','2003-12-04','Shipped','N','151',NULL),
	...
	(10208,'2004-01-02','2004-01-11','2004-01-04','Shipped','N','146',NULL),
	(10209,'2004-01-09','2004-01-15','2004-01-12','Shipped','N','347',NULL),
	(10210,'2004-01-12','2004-01-22','2004-01-20','Shipped','N','177',NULL),
	(10211,'2004-01-15','2004-01-25','2004-01-18','Shipped','N','406',NULL),
	(10212,'2004-01-16','2004-01-24','2004-01-18','Shipped','N','141',NULL),
	...
	(10214,'2004-01-26','2004-02-04','2004-01-29','Shipped','N','458',NULL),
	(10215,'2004-01-29','2004-02-08','2004-02-01','Shipped','Customer requested that FedEx Ground is used for this shipping','475',NULL),
	(10216,'2004-02-02','2004-02-10','2004-02-04','Shipped','N','256',NULL),
	(10217,'2004-02-04','2004-02-14','2004-02-06','Shipped','N','166',NULL),
	...
	(10219,'2004-02-10','2004-02-17','2004-02-12','Shipped','N','487',NULL),
	(10220,'2004-02-12','2004-02-19','2004-02-16','Shipped','N','189',NULL),
	(10221,'2004-02-18','2004-02-26','2004-02-19','Shipped','N','314',NULL),
	(10222,'2004-02-19','2004-02-27','2004-02-20','Shipped','N','239',NULL),
	(10223,'2004-02-20','2004-02-29','2004-02-24','Shipped','N','114',NULL),
	...
	(10225,'2004-02-22','2004-03-01','2004-02-24','Shipped','N','298',NULL),
	(10226,'2004-02-26','2004-03-06','2004-03-02','Shipped','N','239',NULL),
	(10227,'2004-03-02','2004-03-12','2004-03-08','Shipped','N','146',NULL),
	(10228,'2004-03-10','2004-03-18','2004-03-13','Shipped','N','173',NULL),
	(10229,'2004-03-11','2004-03-20','2004-03-12','Shipped','N','124',NULL),
	...
	(10231,'2004-03-19','2004-03-26','2004-03-25','Shipped','N','344',NULL),
	(10232,'2004-03-20','2004-03-30','2004-03-25','Shipped','N','240',NULL),
	...
	(10234,'2004-03-30','2004-04-05','2004-04-02','Shipped','N','412',NULL),
	(10235,'2004-04-02','2004-04-12','2004-04-06','Shipped','N','260',NULL),
	(10236,'2004-04-03','2004-04-11','2004-04-08','Shipped','N','486',NULL),
	(10237,'2004-04-05','2004-04-12','2004-04-10','Shipped','N','181',NULL),
	(10238,'2004-04-09','2004-04-16','2004-04-10','Shipped','N','145',NULL),
	(10239,'2004-04-12','2004-04-21','2004-04-17','Shipped','N','311',NULL),
	(10240,'2004-04-13','2004-04-20','2004-04-20','Shipped','N','177',NULL),
	(10241,'2004-04-13','2004-04-20','2004-04-19','Shipped','N','209',NULL),
	(10242,'2004-04-20','2004-04-28','2004-04-25','Shipped','Customer is interested in buying more Ferrari models','456',NULL),
	(10243,'2004-04-26','2004-05-03','2004-04-28','Shipped','N','495',NULL),
	(10244,'2004-04-29','2004-05-09','2004-05-04','Shipped','N','141',NULL),
	(10245,'2004-05-04','2004-05-12','2004-05-09','Shipped','N','455',NULL),
	(10246,'2004-05-05','2004-05-13','2004-05-06','Shipped','N','141',NULL),
	(10247,'2004-05-05','2004-05-11','2004-05-08','Shipped','N','334',NULL),
	(10248,'2004-05-07','2004-05-14','N','Cancelled','Order was mistakenly placed. The warehouse noticed the lack of documentation.','131',NULL),
	(10249,'2004-05-08','2004-05-17','2004-05-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?','173',NULL),
	(10250,'2004-05-11','2004-05-19','2004-05-15','Shipped','N','450',NULL),
	(10251,'2004-05-18','2004-05-24','2004-05-24','Shipped','N','328',NULL),
	(10252,'2004-05-26','2004-06-04','2004-05-29','Shipped','N','406',NULL),
	...
	(10255,'2004-06-04','2004-06-12','2004-06-09','Shipped','N','209',NULL),
	(10256,'2004-06-08','2004-06-16','2004-06-10','Shipped','N','145',NULL),
	(10257,'2004-06-14','2004-06-24','2004-06-15','Shipped','N','450',NULL),
	(10258,'2004-06-15','2004-06-25','2004-06-23','Shipped','N','398',NULL),
	(10259,'2004-06-15','2004-06-22','2004-06-17','Shipped','N','166',NULL),
	(10260,'2004-06-16','2004-06-22','N','Cancelled','Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.','357',NULL),
	(10261,'2004-06-17','2004-06-25','2004-06-22','Shipped','N','233',NULL),
	(10262,'2004-06-24','2004-07-01','N','Cancelled','This customer found a better offer from one of our competitors. Will call back to renegotiate.','141',NULL),
	(10263,'2004-06-28','2004-07-04','2004-07-02','Shipped','N','175',NULL),
	(10264,'2004-06-30','2004-07-06','2004-07-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2004','362',NULL),
	(10265,'2004-07-02','2004-07-09','2004-07-07','Shipped','N','471',NULL),
	(10266,'2004-07-06','2004-07-14','2004-07-10','Shipped','N','386',NULL),
	(10267,'2004-07-07','2004-07-17','2004-07-09','Shipped','N','151',NULL),
	(10268,'2004-07-12','2004-07-18','2004-07-14','Shipped','N','412',NULL),
	(10269,'2004-07-16','2004-07-22','2004-07-18','Shipped','N','382',NULL),
	(10270,'2004-07-19','2004-07-27','2004-07-24','Shipped','Can we renegotiate this one?','282',NULL),
	(10271,'2004-07-20','2004-07-29','2004-07-23','Shipped','N','124',NULL),
	(10272,'2004-07-20','2004-07-26','2004-07-22','Shipped','N','157',NULL),
	(10273,'2004-07-21','2004-07-28','2004-07-22','Shipped','N','314',NULL),
	(10274,'2004-07-21','2004-07-29','2004-07-22','Shipped','N','379',NULL),
	(10275,'2004-07-23','2004-08-02','2004-07-29','Shipped','N','119',NULL),
	(10276,'2004-08-02','2004-08-11','2004-08-08','Shipped','N','204',NULL),
	(10277,'2004-08-04','2004-08-12','2004-08-05','Shipped','N','148',NULL),
	(10278,'2004-08-06','2004-08-16','2004-08-09','Shipped','N','112',NULL),
	...
	(10280,'2004-08-17','2004-08-27','2004-08-19','Shipped','N','249',NULL),
	(10281,'2004-08-19','2004-08-28','2004-08-23','Shipped','N','157',NULL),
	(10282,'2004-08-20','2004-08-26','2004-08-22','Shipped','N','124',NULL),
	(10283,'2004-08-20','2004-08-30','2004-08-23','Shipped','N','260',NULL),
	(10284,'2004-08-21','2004-08-29','2004-08-26','Shipped','Custom shipping instructions sent to warehouse','299',NULL),
	(10285,'2004-08-27','2004-09-04','2004-08-31','Shipped','N','286',NULL),
	(10286,'2004-08-28','2004-09-06','2004-09-01','Shipped','N','172',NULL),
	(10287,'2004-08-30','2004-09-06','2004-09-01','Shipped','N','298',NULL),
	(10288,'2004-09-01','2004-09-11','2004-09-05','Shipped','N','166',NULL),
	...
	(10290,'2004-09-07','2004-09-15','2004-09-13','Shipped','N','198',NULL),
	(10291,'2004-09-08','2004-09-17','2004-09-14','Shipped','N','448',NULL),
	(10292,'2004-09-08','2004-09-18','2004-09-11','Shipped','They want to reevaluate their terms agreement with Finance.','131',NULL),
	(10293,'2004-09-09','2004-09-18','2004-09-14','Shipped','N','249',NULL),
	(10294,'2004-09-10','2004-09-17','2004-09-14','Shipped','N','204',NULL),
	(10295,'2004-09-10','2004-09-17','2004-09-14','Shipped','They want to reevaluate their terms agreement with Finance.','362',NULL),
	(10296,'2004-09-15','2004-09-22','2004-09-16','Shipped','N','415',NULL),
	...
	(10298,'2004-09-27','2004-10-05','2004-10-01','Shipped','N','103',NULL),
	(10299,'2004-09-30','2004-10-10','2004-10-01','Shipped','N','186',NULL),
	(10300,'2003-10-04','2003-10-13','2003-10-09','Shipped','N','128',NULL),
	(10301,'2003-10-05','2003-10-15','2003-10-08','Shipped','N','299',NULL),
	(10302,'2003-10-06','2003-10-16','2003-10-07','Shipped','N','201',NULL),
	(10303,'2004-10-06','2004-10-14','2004-10-09','Shipped','Customer inquired about remote controlled models and gold models.','484',NULL),
	(10304,'2004-10-11','2004-10-20','2004-10-17','Shipped','N','256',NULL),
	(10305,'2004-10-13','2004-10-22','2004-10-15','Shipped','Check on availability.','286',NULL),
	(10306,'2004-10-14','2004-10-21','2004-10-17','Shipped','N','187',NULL),
	(10307,'2004-10-14','2004-10-23','2004-10-20','Shipped','N','339',NULL),
	(10308,'2004-10-15','2004-10-24','2004-10-20','Shipped','Customer requested that FedEx Ground is used for this shipping','319',NULL),
	(10309,'2004-10-15','2004-10-24','2004-10-18','Shipped','N','121',NULL),
	(10310,'2004-10-16','2004-10-24','2004-10-18','Shipped','N','259',NULL),
	...
	(10312,'2004-10-21','2004-10-27','2004-10-23','Shipped','N','124',NULL),
	(10313,'2004-10-22','2004-10-28','2004-10-25','Shipped','Customer requested that FedEx Ground is used for this shipping','202',NULL),
	(10314,'2004-10-22','2004-11-01','2004-10-23','Shipped','N','227',NULL),
	(10315,'2004-10-29','2004-11-08','2004-10-30','Shipped','N','119',NULL),
	...
	(10317,'2004-11-02','2004-11-12','2004-11-08','Shipped','N','161',NULL),
	(10318,'2004-11-02','2004-11-09','2004-11-07','Shipped','N','157',NULL),
	(10319,'2004-11-03','2004-11-11','2004-11-06','Shipped','Customer requested that DHL is used for this shipping','456',NULL),
	(10320,'2004-11-03','2004-11-13','2004-11-07','Shipped','N','144',NULL),
	(10321,'2004-11-04','2004-11-12','2004-11-07','Shipped','N','462',NULL),
	...
	(10323,'2004-11-05','2004-11-12','2004-11-09','Shipped','N','128',NULL),
	(10324,'2004-11-05','2004-11-11','2004-11-08','Shipped','N','181',NULL),
	(10325,'2004-11-05','2004-11-13','2004-11-08','Shipped','N','121',NULL),
	(10326,'2004-11-09','2004-11-16','2004-11-10','Shipped','N','144',NULL),
	...
	(10329,'2004-11-15','2004-11-24','2004-11-16','Shipped','N','131',NULL),
	(10330,'2004-11-16','2004-11-25','2004-11-21','Shipped','N','385',NULL),
	...
	(10332,'2004-11-17','2004-11-25','2004-11-18','Shipped','N','187',NULL),
	(10333,'2004-11-18','2004-11-27','2004-11-20','Shipped','N','129',NULL),
	(10334,'2004-11-19','2004-11-28','N','On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.','144',NULL),
	(10335,'2004-11-19','2004-11-29','2004-11-23','Shipped','N','124',NULL),
	(10336,'2004-11-20','2004-11-26','2004-11-24','Shipped','Customer requested that DHL is used for this shipping','172',NULL),
	(10337,'2004-11-21','2004-11-30','2004-11-26','Shipped','N','424',NULL),
	(10338,'2004-11-22','2004-12-02','2004-11-27','Shipped','N','381',NULL),
	(10339,'2004-11-23','2004-11-30','2004-11-30','Shipped','N','398',NULL),
	(10340,'2004-11-24','2004-12-01','2004-11-25','Shipped','Customer is interested in buying more Ferrari models','216',NULL),
	(10341,'2004-11-24','2004-12-01','2004-11-29','Shipped','N','382',NULL),
	(10342,'2004-11-24','2004-12-01','2004-11-29','Shipped','N','114',NULL),
	(10343,'2004-11-24','2004-12-01','2004-11-26','Shipped','N','353',NULL),
	(10344,'2004-11-25','2004-12-02','2004-11-29','Shipped','N','350',NULL),
	(10345,'2004-11-25','2004-12-01','2004-11-26','Shipped','N','103',NULL),
	(10346,'2004-11-29','2004-12-05','2004-11-30','Shipped','N','112',NULL),
	(10347,'2004-11-29','2004-12-07','2004-11-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?','114',NULL),
	(10348,'2004-11-01','2004-11-08','2004-11-05','Shipped','N','458',NULL),
	(10349,'2004-12-01','2004-12-07','2004-12-03','Shipped','N','151',NULL),
	(10350,'2004-12-02','2004-12-08','2004-12-05','Shipped','N','141',NULL),
	(10351,'2004-12-03','2004-12-11','2004-12-07','Shipped','N','324',NULL),
	(10352,'2004-12-03','2004-12-12','2004-12-09','Shipped','N','198',NULL),
	(10353,'2004-12-04','2004-12-11','2004-12-05','Shipped','N','447',NULL),
	(10354,'2004-12-04','2004-12-10','2004-12-05','Shipped','N','323',NULL),
	(10355,'2004-12-07','2004-12-14','2004-12-13','Shipped','N','141',NULL),
	(10356,'2004-12-09','2004-12-15','2004-12-12','Shipped','N','250',NULL),
	(10357,'2004-12-10','2004-12-16','2004-12-14','Shipped','N','124',NULL),
	(10358,'2004-12-10','2004-12-16','2004-12-16','Shipped','Customer requested that DHL is used for this shipping','141',NULL),
	(10359,'2004-12-15','2004-12-23','2004-12-18','Shipped','N','353',NULL),
	(10360,'2004-12-16','2004-12-22','2004-12-18','Shipped','N','496',NULL),
	(10361,'2004-12-17','2004-12-24','2004-12-20','Shipped','N','282',NULL),
	(10362,'2005-01-05','2005-01-16','2005-01-10','Shipped','N','161',NULL),
	(10363,'2005-01-06','2005-01-12','2005-01-10','Shipped','N','334',NULL),
	(10364,'2005-01-06','2005-01-17','2005-01-09','Shipped','N','350',NULL),
	(10365,'2005-01-07','2005-01-18','2005-01-11','Shipped','N','320',NULL),
	(10366,'2005-01-10','2005-01-19','2005-01-12','Shipped','N','381',NULL),
	...
	(10369,'2005-01-20','2005-01-28','2005-01-24','Shipped','N','379',NULL),
	(10370,'2005-01-20','2005-02-01','2005-01-25','Shipped','N','276',NULL),
	(10371,'2005-01-23','2005-02-03','2005-01-25','Shipped','N','124',NULL),
	(10372,'2005-01-26','2005-02-05','2005-01-28','Shipped','N','398',NULL),
	(10373,'2005-01-31','2005-02-08','2005-02-06','Shipped','N','311',NULL),
	(10374,'2005-02-02','2005-02-09','2005-02-03','Shipped','N','333',NULL),
	(10375,'2005-02-03','2005-02-10','2005-02-06','Shipped','N','119',NULL),
	(10376,'2005-02-08','2005-02-18','2005-02-13','Shipped','N','219',NULL),
	...
	(10378,'2005-02-10','2005-02-18','2005-02-11','Shipped','N','141',NULL),
	(10379,'2005-02-10','2005-02-18','2005-02-11','Shipped','N','141',NULL),
	(10380,'2005-02-16','2005-02-24','2005-02-18','Shipped','N','141',NULL),
	(10381,'2005-02-17','2005-02-25','2005-02-18','Shipped','N','321',NULL),
	(10382,'2005-02-17','2005-02-23','2005-02-18','Shipped','Custom shipping instructions sent to warehouse','124',NULL),
	(10383,'2005-02-22','2005-03-02','2005-02-25','Shipped','N','141',NULL),
	(10384,'2005-02-23','2005-03-06','2005-02-27','Shipped','N','321',NULL),
	(10385,'2005-02-28','2005-03-09','2005-03-01','Shipped','N','124',NULL),
	...
	(10388,'2005-03-03','2005-03-11','2005-03-09','Shipped','N','462',NULL),
	(10389,'2005-03-03','2005-03-09','2005-03-08','Shipped','N','448',NULL),
	(10390,'2005-03-04','2005-03-11','2005-03-07','Shipped','They want to reevaluate their terms agreement with Finance.','124',NULL),
	(10391,'2005-03-09','2005-03-20','2005-03-15','Shipped','N','276',NULL),
	(10392,'2005-03-10','2005-03-18','2005-03-12','Shipped','N','452',NULL),
	(10393,'2005-03-11','2005-03-22','2005-03-14','Shipped','They want to reevaluate their terms agreement with Finance.','323',NULL),
	(10394,'2005-03-15','2005-03-25','2005-03-19','Shipped','N','141',NULL),
	...
	(10396,'2005-03-23','2005-04-02','2005-03-28','Shipped','N','124',NULL),
	(10397,'2005-03-28','2005-04-09','2005-04-01','Shipped','N','242',NULL),
	(10398,'2005-03-30','2005-04-09','2005-03-31','Shipped','N','353',NULL),
	(10399,'2005-04-01','2005-04-12','2005-04-03','Shipped','N','496',NULL),
	(10400,'2005-04-01','2005-04-11','2005-04-04','Shipped','Customer requested that DHL is used for this shipping','450',NULL),
	(10401,'2005-04-03','2005-04-14','N','On Hold','Customer credit limit exceeded. Will ship when a payment is received.','328',NULL),
	(10402,'2005-04-07','2005-04-14','2005-04-12','Shipped','N','406',NULL),
	(10403,'2005-04-08','2005-04-18','2005-04-11','Shipped','N','201',NULL),
	(10404,'2005-04-08','2005-04-14','2005-04-11','Shipped','N','323',NULL),
	(10405,'2005-04-14','2005-04-24','2005-04-20','Shipped','N','209',NULL),
	...
	(10407,'2005-04-22','2005-05-04','N','On Hold','Customer credit limit exceeded. Will ship when a payment is received.','450',NULL),
	(10408,'2005-04-22','2005-04-29','2005-04-27','Shipped','N','398',NULL),
	(10409,'2005-04-23','2005-05-05','2005-04-24','Shipped','N','166',NULL),
	(10410,'2005-04-29','2005-05-10','2005-04-30','Shipped','N','357',NULL),
	(10411,'2005-05-01','2005-05-08','2005-05-06','Shipped','N','233',NULL),
	(10412,'2005-05-03','2005-05-13','2005-05-05','Shipped','N','141',NULL),
	(10413,'2005-05-05','2005-05-14','2005-05-09','Shipped','Customer requested that DHL is used for this shipping','175',NULL),
	(10414,'2005-05-06','2005-05-13','N','On Hold','Customer credit limit exceeded. Will ship when a payment is received.','362',NULL),
	...
	(10416,'2005-05-10','2005-05-16','2005-05-14','Shipped','N','386',NULL),
	(10417,'2005-05-13','2005-05-19','2005-05-19','Disputed','Customer doesn\'t like the colors and precision of the models.','141',NULL),
	(10418,'2005-05-16','2005-05-24','2005-05-20','Shipped','N','412',NULL),
	(10419,'2005-05-17','2005-05-28','2005-05-19','Shipped','N','382',NULL),
	(10420,'2005-05-29','2005-06-07','N','In Process','N','282',NULL),
	(10421,'2005-05-29','2005-06-06','N','In Process','Custom shipping instructions were sent to warehouse','124',NULL),
	(10422,'2005-05-30','2005-06-11','N','In Process','N','157',NULL),
	(10423,'2005-05-30','2005-06-05','N','In Process','N','314',NULL),
	(10424,'2005-05-31','2005-06-08','N','In Process','N','141',NULL),
	(10425,'2005-05-31','2005-06-07','N','In Process','N','119',NULL);
...
CREATE TABLE `payments` (
  `customerNumber` varchar(300) DEFAULT NULL,
  `checkNumber` varchar(300) DEFAULT NULL,
...
CREATE TABLE `productlines` (
  `productLine` varchar(300) DEFAULT NULL,
  `textDescription` varchar(3000) DEFAULT NULL,
  `htmlDescription` varchar(300) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `productName` varchar(43) NOT NULL,
  `productLine` varchar(16) NOT NULL,
  `productScale` varchar(5) NOT NULL,
  `productVendor` varchar(25) NOT NULL,
  `productDescription` varchar(497) NOT NULL,
  `quantityInStock` varchar(31) NOT NULL,
  `buyPrice` varchar(52) NOT NULL,
  `MSRP` varchar(24) NOT NULL,
  `FIELD10` varchar(50) DEFAULT NULL,
  `FIELD11` varchar(14) DEFAULT NULL,
  `FIELD12` varchar(14) DEFAULT NULL,
  `FIELD13` varchar(22) DEFAULT NULL,
  `FIELD14` int DEFAULT NULL,
...
INSERT INTO `products` (`productCode`, `productName`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`, `FIELD10`, `FIELD11`, `FIELD12`, `FIELD13`, `FIELD14`, `FIELD15`, `FIELD16`)
VALUES
	('S10_1678','1969 Harley Davidson Ultimate Chopper','Motorcycles','1:10','Min Lin Diecast','This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.','7933','48.81','95.7',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S10_4698','2003 Harley-Davidson Eagle Drag Bike','Motorcycles','1:10','Red Start Diecast','Model features, official Harley Davidson logos and insignias, detachable rear wheelie bar, heavy diecast metal with resin parts, authentic multi-color tampo-printed graphics, separate engine drive belts, free-turning front fork, rotating tires and rear racing slick, certificate of authenticity, detailed engine, display stand\r\n, precision diecast replica, baked enamel finish, 1:10 scale model, removable fender, seat and tank cover piece for displaying the superior detail of the v-twin engine','5582','91.02','193.66',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S12_1099','1968 Ford Mustang','Classic Cars','1:12','Autoart Studio Design','Hood, doors and trunk all open to reveal highly detailed interior features. Steering wheel actually turns the front wheels. Color dark green.','68','95.34','194.57',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S12_1666','1958 Setra Bus','Trucks and Buses','1:12','Welly Diecast Productions','Model features 30 windows, skylights & glare resistant glass, working steering system, original logos','1579','77.9','136.67',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S12_2823','2002 Suzuki XREO','Motorcycles','1:12','Unimax Art Galleries','Official logos and insignias, saddle bags located on side of motorcycle, detailed engine, working steering, working suspension, two leather seats, luggage rack, dual exhaust pipes, small saddle bag located on handle bars, two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand, diecast metal with plastic parts and baked enamel finish.','9997','66.27','150.62',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S12_3148','1969 Corvair Monza','Classic Cars','1:18','Welly Diecast Productions','1:18 scale die-cast about 10 long doors open, hood opens, trunk opens and wheels roll','6906','89.14','151.08',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S12_3380','1968 Dodge Charger','Classic Cars','1:12','Welly Diecast Productions','1:12 scale model of a 1968 Dodge Charger. Hood, doors and trunk all open to reveal highly detailed interior features. Steering wheel actually turns the front wheels. Color black','9123','75.16','117.44',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S12_3990','1970 Plymouth Hemi Cuda','Classic Cars','1:12','Studio M Art Models','Very detailed 1970 Plymouth Cuda model in 1:12 scale. The Cuda is generally accepted as one of the fastest original muscle cars from the 1970s. This model is a reproduction of one of the orginal 652 cars built in 1970. Red color.','5663','31.92','79.8',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S12_4473','1957 Chevy Pickup','Trucks and Buses','1:12','Exoto Designs','1:12 scale die-cast about 20 long Hood opens, Rubber wheels','6125','55.7','118.5',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S12_4675','1969 Dodge Charger','Classic Cars','1:12','Welly Diecast Productions','Detailed model of the 1969 Dodge Charger. This model includes finely detailed interior and exterior features. Painted in red and white.','7323','58.73','115.16',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1097','1940 Ford Pickup Truck','Trucks and Buses','1:18','Studio M Art Models','This model features soft rubber tires, working steering, rubber mud guards, authentic Ford logos, detailed undercarriage, opening doors and hood,  removable split rear gate, full size spare mounted in bed, detailed interior with opening glove box','2613','58.33','116.67',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1129','1993 Mazda RX-7','Classic Cars','1:18','Highway 66 Mini Classics','This model features, opening hood, opening doors, detailed engine, rear spoiler, opening trunk, working steering, tinted windows, baked enamel finish. Color red.','3975','83.51','141.54',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1342','1937 Lincoln Berline','Vintage Cars','1:18','Motor City Art Classics','Features opening engine cover, doors, trunk, and fuel filler cap. Color black','8693','60.62','102.74',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1367','1936 Mercedes-Benz 500K Special Roadster','Vintage Cars','1:18','Studio M Art Models','This 1:18 scale replica is constructed of heavy die-cast metal and has all the features of the original: working doors and rumble seat, independent spring suspension, detailed interior, working steering system, and a bifold hood that reveals an engine so accurate that it even includes the wiring. All this is topped off with a baked enamel finish. Color white.','8635','24.26','53.91',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1589','1965 Aston Martin DB5','Classic Cars','1:18','Classic Metal Creations','Die-cast model of the silver 1965 Aston Martin DB5 in silver. This model includes full wire wheels and doors that open with fully detailed passenger compartment. In 1:18 scale, this model measures approximately 10 inches/20 cm long.','9042','65.96','124.44',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1662','1980s Black Hawk Helicopter','Planes','1:18','Red Start Diecast','1:18 scale replica of actual Army\'s UH-60L BLACK HAWK Helicopter. 100% hand-assembled. Features rotating rotor blades, propeller blades and rubber wheels.','5330','77.27','157.69',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1749','1917 Grand Touring Sedan','Vintage Cars','1:18','Welly Diecast Productions','This 1:18 scale replica of the 1917 Grand Touring car has all the features you would expect from museum quality reproductions: all four doors and bi-fold hood opening, detailed engine and instrument panel, chrome-look trim, and tufted upholstery, all topped off with a factory baked-enamel finish.','2724','86.7','170',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1889','1948 Porsche 356-A Roadster','Classic Cars','1:18','Gearbox Collectibles','This precision die-cast replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','8826','53.9','77',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_1984','1995 Honda Civic','Classic Cars','1:18','Min Lin Diecast','This model features, opening hood, opening doors, detailed engine, rear spoiler, opening trunk, working steering, tinted windows, baked enamel finish. Color yellow.','9772','93.89','142.25',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S18_2248','1911 Ford Town Car','Vintage Cars','1:18','Motor City Art Classics','Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system.','540','33.3','60.54',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2319','1964 Mercedes Tour Bus','Trucks and Buses','1:18','Unimax Art Galleries','Exact replica. 100+ parts. working steering system, original logos','8258','74.86','122.73',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2325','1932 Model A Ford J-Coupe','Vintage Cars','1:18','Autoart Studio Design','This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system, chrome-covered spare, opening doors, detailed and wired engine','9354','58.48','127.13',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2432','1926 Ford Fire Engine','Trucks and Buses','1:18','Carousel DieCast Legends','Gleaming red handsome appearance. Everything is here the fire hoses, ladder, axes, bells, lanterns, ready to fight any inferno.','2018','24.92','60.77',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2581','P-51-D Mustang','Planes','1:72','Gearbox Collectibles','Has retractable wheels and comes with a stand','992','49','84.48',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2625','1936 Harley Davidson El Knucklehead','Motorcycles','1:18','Welly Diecast Productions','Intricately detailed with chrome accents and trim, official die-struck logos and baked enamel finish.','4357','24.23','60.57',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2795','1928 Mercedes-Benz SSK','Vintage Cars','1:18','Gearbox Collectibles','This 1:18 replica features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system, chrome-covered spare, opening doors, detailed and wired engine. Color black.','548','72.56','168.75',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2870','1999 Indy 500 Monte Carlo SS','Classic Cars','1:18','Red Start Diecast','Features include opening and closing doors. Color: Red','8164','56.76','132',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2949','1913 Ford Model T Speedster','Vintage Cars','1:18','Carousel DieCast Legends','This 250 part reproduction includes moving handbrakes, clutch, throttle and foot pedals, squeezable horn, detailed wired engine, removable water, gas, and oil cans, pivoting monocle windshield, all topped with a baked enamel red finish. Each replica comes with an Owners Title and Certificate of Authenticity. Color red.','4189','60.78','101.31',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_2957','1934 Ford V8 Coupe','Vintage Cars','1:18','Min Lin Diecast','Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System','5649','34.35','62.46',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3029','1999 Yamaha Speed Boat','Ships','1:18','Min Lin Diecast','Exact replica. Wood and Metal. Many extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.','4259','51.61','86.02',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3136','18th Century Vintage Horse Carriage','Vintage Cars','1:18','Red Start Diecast','Hand crafted diecast-like metal horse carriage is re-created in about 1:18 scale of antique horse carriage. This antique style metal Stagecoach is all hand-assembled with many different parts.\r\n\r\nThis collectible metal horse carriage is painted in classic Red, and features turning steering wheel and is entirely hand-finished.','5992','60.74','104.72',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3140','1903 Ford Model A','Vintage Cars','1:18','Unimax Art Galleries','Features opening trunk,  working steering system','3913','68.3','136.59',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3232','1992 Ferrari 360 Spider red','Classic Cars','1:18','Unimax Art Galleries','his replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','8347','77.9','169.34',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3233','1985 Toyota Supra','Classic Cars','1:18','Highway 66 Mini Classics','This model features soft rubber tires, working steering, rubber mud guards, authentic Ford logos, detailed undercarriage, opening doors and hood, removable split rear gate, full size spare mounted in bed, detailed interior with opening glove box','7733','57.01','107.57',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S18_3278','1969 Dodge Super Bee','Classic Cars','1:18','Min Lin Diecast','This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','1917','49.05','80.41',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3320','1917 Maxwell Touring Car','Vintage Cars','1:18','Exoto Designs','Features Gold Trim, Full Size Spare Tire, Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System','7913','57.54','99.21',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3482','1976 Ford Gran Torino','Classic Cars','1:18','Gearbox Collectibles','Highly detailed 1976 Ford Gran Torino Starsky and Hutch diecast model. Very well constructed and painted in red and white patterns.','9127','73.49','146.99',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3685','1948 Porsche Type 356 Roadster','Classic Cars','1:18','Gearbox Collectibles','This model features working front and rear suspension on accurately replicated and actuating shock absorbers as well as opening engine cover, rear stabilizer flap,  and 4 opening doors.','8990','62.16','141.28',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3782','1957 Vespa GS150','Motorcycles','1:18','Studio M Art Models','Features rotating wheels , working kick stand. Comes with stand.','7689','32.95','62.17',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_3856','1941 Chevrolet Special Deluxe Cabriolet','Vintage Cars','1:18','Exoto Designs','Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system, leather upholstery. Color black.','2378','64.58','105.87',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4027','1970 Triumph Spitfire','Classic Cars','1:18','Min Lin Diecast','Features include opening and closing doors. Color: White.','5545','91.92','143.62',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4409','1932 Alfa Romeo 8C2300 Spider Sport','Vintage Cars','1:18','Exoto Designs','This 1:18 scale precision die cast replica features the 6 front headlights of the original, plus a detailed version of the 142 horsepower straight 8 engine, dual spares and their famous comprehensive dashboard. Color black.','6553','43.26','92.03',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4522','1904 Buick Runabout','Vintage Cars','1:18','Exoto Designs','Features opening trunk,  working steering system','8290','52.66','87.77',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4600','1940s Ford truck','Trucks and Buses','1:18','Motor City Art Classics','This 1940s Ford Pick-Up truck is re-created in 1:18 scale of original 1940s Ford truck. This antique style metal 1940s Ford Flatbed truck is all hand-assembled. This collectible 1940\'s Pick-Up truck is painted in classic dark green color, and features rotating wheels.','3128','84.76','121.08',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4668','1939 Cadillac Limousine','Vintage Cars','1:18','Studio M Art Models','Features completely detailed interior including Velvet flocked drapes,deluxe wood grain floor, and a wood grain casket with seperate chrome handles','6645','23.14','50.31',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4721','1957 Corvette Convertible','Classic Cars','1:18','Classic Metal Creations','1957 die cast Corvette Convertible in Roman Red with white sides and whitewall tires. 1:18 scale quality die-cast with detailed engine and underbvody. Now you can own The Classic Corvette.','1249','69.93','148.8',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S18_4933','1957 Ford Thunderbird','Classic Cars','1:18','Studio M Art Models','This 1:18 scale precision die-cast replica, with its optional porthole hardtop and factory baked-enamel Thunderbird Bronze finish, is a 100% accurate rendition of this American classic.','3209','34.21','71.27',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1046','1970 Chevy Chevelle SS 454','Classic Cars','1:24','Unimax Art Galleries','This model features rotating wheels, working streering system and opening doors. All parts are particularly delicate due to their precise scale and require special care and attention. It should not be picked up by the doors, roof, hood or trunk.','1005','49.24','73.49',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1444','1970 Dodge Coronet','Classic Cars','1:24','Highway 66 Mini Classics','1:24 scale die-cast about 18 long doors open, hood opens and rubber wheels','4074','32.37','57.8',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1578','1997 BMW R 1100 S','Motorcycles','1:24','Autoart Studio Design','Detailed scale replica with working suspension and constructed from over 70 parts','7003','60.86','112.7',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1628','1966 Shelby Cobra 427 S/C','Classic Cars','1:24','Carousel DieCast Legends','This diecast model of the 1966 Shelby Cobra 427 S/C includes many authentic details and operating parts. The 1:24 scale model of this iconic lighweight sports car from the 1960s comes in silver and it\'s own display case.','8197','29.18','50.31',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1785','1928 British Royal Navy Airplane','Planes','1:24','Classic Metal Creations','Official logos and insignias','3627','66.74','109.42',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_1937','1939 Chevrolet Deluxe Coupe','Vintage Cars','1:24','Motor City Art Classics','This 1:24 scale die-cast replica of the 1939 Chevrolet Deluxe Coupe has the same classy look as the original. Features opening trunk, hood and doors and a showroom quality baked enamel finish.','7332','22.57','33.19',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2000','1960 BSA Gold Star DBD34','Motorcycles','1:24','Highway 66 Mini Classics','Detailed scale replica with working suspension and constructed from over 70 parts','15','37.32','76.17',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2011','18th century schooner','Ships','1:24','Carousel DieCast Legends','All wood with canvas sails. Many extras including rigging, long boats, pilot house, anchors, etc. Comes with 4 masts, all square-rigged.','1898','82.34','122.89',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2022','1938 Cadillac V-16 Presidential Limousine','Vintage Cars','1:24','Classic Metal Creations','This 1:24 scale precision die cast replica of the 1938 Cadillac V-16 Presidential Limousine has all the details of the original, from the flags on the front to an opening back seat compartment complete with telephone and rifle. Features factory baked-enamel black finish, hood goddess ornament, working jump seats.','2847','20.61','44.8',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2300','1962 Volkswagen Microbus','Trucks and Buses','1:24','Autoart Studio Design','This 1:18 scale die cast replica of the 1962 Microbus is loaded with features: A working steering system, opening front doors and tailgate, and famous two-tone factory baked enamel finish, are all topped of by the sliding, real fabric, sunroof.','2327','61.34','127.79',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2360','1982 Ducati 900 Monster','Motorcycles','1:24','Highway 66 Mini Classics','Features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand','6840','47.1','69.26',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2766','1949 Jaguar XK 120','Classic Cars','1:24','Classic Metal Creations','Precision-engineered from original Jaguar specification in perfect scale ratio. Features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','2350','47.25','90.87',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2840','1958 Chevy Corvette Limited Edition','Classic Cars','1:24','Carousel DieCast Legends','The operating parts of this 1958 Chevy Corvette Limited Edition are particularly delicate due to their precise scale and require special care and attention. Features rotating wheels, working streering, opening doors and trunk. Color dark green.','2542','15.91','35.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2841','1900s Vintage Bi-Plane','Planes','1:24','Autoart Studio Design','Hand crafted diecast-like metal bi-plane is re-created in about 1:24 scale of antique pioneer airplane. All hand-assembled with many different parts. Hand-painted in classic yellow and features correct markings of original airplane.','5942','34.25','68.51',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2887','1952 Citroen-15CV','Classic Cars','1:24','Exoto Designs','Precision crafted hand-assembled 1:18 scale reproduction of the 1952 15CV, with its independent spring suspension, working steering system, opening doors and hood, detailed engine and instrument panel, all topped of with a factory fresh baked enamel finish.','1452','72.82','117.44',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_2972','1982 Lamborghini Diablo','Classic Cars','1:24','Second Gear Diecast','This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','7723','16.24','37.76',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3151','1912 Ford Model T Delivery Wagon','Vintage Cars','1:24','Min Lin Diecast','This model features chrome trim and grille, opening hood, opening doors, opening trunk, detailed engine, working steering system. Color white.','9173','46.91','88.51',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3191','1969 Chevrolet Camaro Z28','Classic Cars','1:24','Exoto Designs','1969 Z/28 Chevy Camaro 1:24 scale replica. The operating parts of this limited edition 1:24 scale diecast model car 1969 Chevy Camaro Z28- hood, trunk, wheels, streering, suspension and doors- are particularly delicate due to their precise scale and require special care and attention.','4695','50.51','85.61',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3371','1971 Alpine Renault 1600s','Classic Cars','1:24','Welly Diecast Productions','This 1971 Alpine Renault 1600s replica Features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','7995','38.58','61.23',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3420','1937 Horch 930V Limousine','Vintage Cars','1:24','Autoart Studio Design','Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system','2902','26.3','65.75',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3432','2002 Chevy Corvette','Classic Cars','1:24','Gearbox Collectibles','The operating parts of this limited edition Diecast 2002 Chevy Corvette 50th Anniversary Pace car Limited Edition are particularly delicate due to their precise scale and require special care and attention. Features rotating wheels, poseable streering, opening doors and trunk.','9446','62.11','107.08',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3816','1940 Ford Delivery Sedan','Vintage Cars','1:24','Carousel DieCast Legends','Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System. Color black.','6621','48.64','83.86',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S24_3949','Corsair F4U ( Bird Cage)','Planes','1:24','Second Gear Diecast','Has retractable wheels and comes with a stand. Official logos and insignias.','6812','29.34','68.24',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_3969','1936 Mercedes Benz 500k Roadster','Vintage Cars','1:24','Red Start Diecast','This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system and rubber wheels. Color black.','2081','21.75','41.03',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_4048','1992 Porsche Cayenne Turbo Silver','Classic Cars','1:24','Exoto Designs','This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.','6582','69.78','118.28',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_4258','1936 Chrysler Airflow','Vintage Cars','1:24','Second Gear Diecast','Features opening trunk,  working steering system. Color dark green.','4710','57.46','97.39',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S24_4278','1900s Vintage Tri-Plane','Planes','1:24','Unimax Art Galleries','Hand crafted diecast-like metal Triplane is Re-created in about 1:24 scale of antique pioneer airplane. This antique style metal triplane is all hand-assembled with many different parts.','2756','36.23','72.45',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	...
	('S32_1268','1980’s GM Manhattan Express','Trucks and Buses','1:32','Motor City Art Classics','This 1980’s era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.','5099','53.93','96.31',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_1374','1997 BMW F650 ST','Motorcycles','1:32','Exoto Designs','Features official die-struck logos and baked enamel finish. Comes with stand.','178','66.92','99.89',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_2206','1982 Ducati 996 R','Motorcycles','1:32','Gearbox Collectibles','Features rotating wheels , working kick stand. Comes with stand.','9241','24.14','40.23',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_2509','1954 Greyhound Scenicruiser','Trucks and Buses','1:32','Classic Metal Creations','Model features bi-level seating, 50 windows, skylights & glare resistant glass, working steering system, original logos','2874','25.98','54.11',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_3207','1950\'s Chicago Surface Lines Streetcar','Trains','1:32','Gearbox Collectibles','This streetcar is a joy to see. It has 80 separate windows, electric wire guides, detailed interiors with seats, poles and drivers controls, rolling and turning wheel assemblies, plus authentic factory baked-enamel finishes (Green Hornet for Chicago and Cream and Crimson for Boston).','8601','26.72','62.14',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_3522','1996 Peterbilt 379 Stake Bed with Outrigger','Trucks and Buses','1:32','Red Start Diecast','This model features, opening doors, detailed engine, working steering, tinted windows, detailed interior, die-struck logos, removable stakes operating outriggers, detachable second trailer, functioning 360-degree self loader, precision molded resin trailer and trim, baked enamel finish on cab','814','33.61','64.64',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_4289','1928 Ford Phaeton Deluxe','Vintage Cars','1:32','Highway 66 Mini Classics','This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system','136','33.02','68.79',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S32_4485','1974 Ducati 350 Mk3 Desmo','Motorcycles','1:32','Second Gear Diecast','This model features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand','3341','56.13','102.05',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S50_1341','1930 Buick Marquette Phaeton','Vintage Cars','1:50','Studio M Art Models','Features opening trunk,  working steering system','7062','27.06','43.64',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S50_1392','Diamond T620 Semi-Skirted Tanker','Trucks and Buses','1:50','Highway 66 Mini Classics','This limited edition model is licensed and perfectly scaled for Lionel Trains. The Diamond T620 has been produced in solid precision diecast and painted with a fire baked enamel finish. It comes with a removable tanker and is a perfect model to add authenticity to your static train or car layout or to just have on display.','1016','68.29','115.75',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S50_1514','1962 City of Detroit Streetcar','Trains','1:50','Classic Metal Creations','This streetcar is a joy to see. It has 99 separate windows, electric wire guides, detailed interiors with seats, poles and drivers controls, rolling and turning wheel assemblies, plus authentic factory baked-enamel finishes (Green Hornet for Chicago and Cream and Crimson for Boston).','1645','37.49','58.58',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S50_4713','2002 Yamaha YZR M1','Motorcycles','1:50','Autoart Studio Design','Features rotating wheels , working kick stand. Comes with stand.','600','34.17','81.36',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_1138','The Schooner Bluenose','Ships','1:700','Autoart Studio Design','All wood with canvas sails. Measures 31 1/2 inches in Length, 22 inches High and 4 3/4 inches Wide. Many extras.\r\nThe schooner Bluenose was built in Nova Scotia in 1921 to fish the rough waters off the coast of Newfoundland. Because of the Bluenose racing prowess she became the pride of all Canadians. Still featured on stamps and the Canadian dime, the Bluenose was lost off Haiti in 1946.','1897','34','66.67',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_1691','American Airlines: B767-300','Planes','1:700','Min Lin Diecast','Exact replia with official logos and insignias and retractable wheels','5841','51.15','91.34',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_1938','The Mayflower','Ships','1:700','Studio M Art Models','Measures 31 1/2 inches Long x 25 1/2 inches High x 10 5/8 inches Wide\r\nAll wood with canvas sail. Extras include long boats, rigging, ladders, railing, anchors, side cannons, hand painted, etc.','737','43.3','86.61',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_2047','HMS Bounty','Ships','1:700','Unimax Art Galleries','Measures 30 inches Long x 27 1/2 inches High x 4 3/4 inches Wide. \r\nMany extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.','3501','39.83','90.52',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_2466','America West Airlines B757-200','Planes','1:700','Motor City Art Classics','Official logos and insignias. Working steering system. Rotating jet engines','9653','68.8','99.72',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_2610','The USS Constitution Ship','Ships','1:700','Red Start Diecast','All wood with canvas sails. Measures 31 1/2 Length x 22 3/8 High x 8 1/4 Width. Extras include 4 boats on deck, sea sprite on bow, anchors, copper railing, pilot houses, etc.','7083','33.97','72.28',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_2824','1982 Camaro Z28','Classic Cars','1:18','Carousel DieCast Legends','Features include opening and closing doors. Color: White. \r\nMeasures approximately 9 1/2 Long.','6934','46.53','101.15',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_2834','ATA: B757-300','Planes','1:700','Highway 66 Mini Classics','Exact replia with official logos and insignias and retractable wheels','7106','59.33','118.65',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_3167','F/A 18 Hornet 1/72','Planes','1:72','Motor City Art Classics','10 Wingspan with retractable landing gears.Comes with pilot','551','54.4','80',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_3505','The Titanic','Ships','1:700','Carousel DieCast Legends','Completed model measures 19 1/2 inches long, 9 inches high, 3inches wide and is in barn red/black. All wood and metal.','1956','51.09','100.17',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_3962','The Queen Mary','Ships','1:700','Welly Diecast Productions','Exact replica. Wood and Metal. Many extras including rigging, long boats, pilot house, anchors, etc. Comes with three masts, all square-rigged.','5088','53.63','99.31',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S700_4002','American Airlines: MD-11S','Planes','1:700','Second Gear Diecast','Polished finish. Exact replia with official logos and insignias and retractable wheels','8820','36.27','74.03',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S72_1253','Boeing X-32A JSF','Planes','1:72','Motor City Art Classics','10 Wingspan with retractable landing gears.Comes with pilot','4857','32.77','49.66',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
	('S72_3212','Pont Yacht','Ships','1:72','Unimax Art Galleries','Measures 38 inches Long x 33 3/4 inches High. Includes a stand.\r\nMany extras including rigging, long boats, pilot house, anchors, etc. Comes with 2 masts, all square-rigged','414','33.3','54.6',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
